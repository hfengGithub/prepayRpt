...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[uv_agentFee]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[uv_agentFee]
GO
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[uv_Loan_FAct_Sum]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[uv_Loan_FAct_Sum]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[uv_MA_DC_loan]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[uv_MA_DC_loan]
GO
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[uv_haus_amortization_info]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[uv_haus_amortization_info]
GO
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[rpt_portfolioLoan]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[rpt_portfolioLoan]
GO
...
CREATE TABLE [dbo].[uv_agentFee] (
	[agt_LoanNumber] [int] NULL ,
	[agt_TotalUnamortizedAgentFee] [money] NULL ,
	[agt_Participation] [decimal](19, 7) NULL 
) ON [PRIMARY]
GO
...
CREATE TABLE [dbo].[uv_Loan_FAct_Sum] (
	[lfs_LoanNumber] [int] NULL ,
	[lfs_HedgeID] [nvarchar] (15) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ,
	[lfs_SumOfFHLBCDailyAssetPL] [money] NULL ,
	[lfs_SumOfPaydownAdjustment] [money] NULL 
) ON [PRIMARY]
GO

CREATE TABLE [dbo].[uv_MA_DC_loan] (
	[mdl_MANumber] [int] NOT NULL ,
	[mdl_PFInumber] [int] NULL ,
	[mdl_DCNumber] [int] NULL ,
	[mdl_LoanNumber] [int] NOT NULL ,
	[mdl_ChicagoParticipation] [decimal](19, 7) NULL 
) ON [PRIMARY]
GO
...
CREATE TABLE [dbo].[uv_haus_amortization_info] (
	[hai_LoanNumber] [int] NULL ,
	[hai_StartDate] [smalldatetime] NULL ,
	[hai_AmortType] [nvarchar] (1) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ,
	[hai_HedgeID] [nvarchar] (15) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ,
	[hai_LoanBalance] [money] NULL ,
	[hai_TotalStrip] [money] NULL ,
	[hai_AmortizePIF] [bit] NOT NULL ,
	[hai_UnamortizedNet] [money] NULL ,
	[hai_DailyAmortization] [money] NULL ,
	[hai_AmortizedThruDate] [smalldatetime] NULL ,
	[hai_UpdateTime] [smalldatetime] NULL ,
	[hai_ConstantYield] [decimal](19, 7) NULL ,
	[hai_RemainingAvgLife] [decimal](19, 7) NULL ,
	[hai_YieldCalcDate] [smalldatetime] NULL ,
	[hai_ConstantYieldAuditID] [int] NULL ,
	[hai_AmortAuditID] [int] NULL ,
	[hai_AgentFeeToDate] [money] NULL 
) ON [PRIMARY]
GO
...
CREATE TABLE [dbo].[rpt_portfolioLoan] (
	[pl_DCnumber] [int] NULL ,
	[pl_LoanNumber] [int] NOT NULL ,
	[pl_ChicagoParticipation] [decimal](19, 7) NULL 
) ON [PRIMARY]
GO
...
ALTER TABLE [dbo].[uv_MA_DC_loan] WITH NOCHECK ADD 
	CONSTRAINT [PK_uv_MA_DC_loan] PRIMARY KEY  CLUSTERED 
	(
		[mdl_LoanNumber]
	)  ON [PRIMARY] 
GO
...
------- 20040412
   ...
   FROM   
      ...
      AND    EXISTS (SELECT 1 FROM rpt_portfolioLoan WHERE PL_loanNumber=f.lfs_loanNumber)    --- 20041020
...
CREATE PROCEDURE usp_setPortfolioFactor AS
   ...
   FROM   rpt_Master m left outer join rpt_portfolioLoan p28 on m.ms_loanIDNumber=p28.pl_loanNUmber
